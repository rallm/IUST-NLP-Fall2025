...
\begin{itemize}
    ...
    \item \textbf{Incorrect dependency}: citing $\rightarrow$ about 
    \item \textbf{Correct dependency}: concerns $\rightarrow$ about
\end{itemize}
}
...
\begin{itemize}
    ...
    \item \textbf{Incorrect dependency}: declined $\rightarrow$ to 
    \item \textbf{Correct dependency}: declined  $\rightarrow$ comment
\end{itemize}
}
...
\begin{itemize}
    ...
    \item \textbf{Incorrect dependency}: and $\rightarrow$ one 
